...
import com.goforer.designsystem.theme.ColorSystemGray9
import com.goforer.designsystem.theme.DarkGreen10
...
fun SettingContent(
    ...
    Column(
        ...
        HorizontalDivider(Modifier, thickness = 4.dp, color = ColorSystemGray9)
